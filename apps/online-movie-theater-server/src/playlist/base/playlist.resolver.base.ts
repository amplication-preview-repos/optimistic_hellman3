...
export class PlaylistResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Movie], { name: "movies" })
  @nestAccessControl.UseRoles({
    resource: "Movie",
    action: "read",
    possession: "any",
  ...
  async findMovies(
    ...
    const results = await this.service.findMovies(parent.id, args);
  ...
  async getRoom(@graphql.Parent() parent: Playlist): Promise<Room | null> {
