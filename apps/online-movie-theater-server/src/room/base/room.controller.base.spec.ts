  ...
  test("POST /rooms", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastActivityAt: CREATE_RESULT.lastActivityAt.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          lastActivityAt: FIND_MANY_RESULT[0].lastActivityAt.toISOString(),
        },
      ]);
  });
  ...
  test("GET /rooms/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastActivityAt: FIND_ONE_RESULT.lastActivityAt.toISOString(),
      });
  });
